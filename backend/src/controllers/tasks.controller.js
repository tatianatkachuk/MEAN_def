...
function createTask(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, name, difficulty, deadline, newTask, task;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = req.body, name = _a.name, difficulty = _a.difficulty, deadline = _a.deadline;
                    newTask = { name: name, difficulty: difficulty, deadline: deadline };
                    task = new Task_1.default(newTask);
